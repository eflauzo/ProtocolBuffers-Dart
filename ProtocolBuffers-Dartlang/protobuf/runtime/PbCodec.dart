...
class _Constants {
  ...
  // 2^512, 2^-512
  static const double POWER_512 = 1.3407807929942597E154;
  static const double POWER_MINUS_512 = 7.458340731200207E-155;
  // 2^256, 2^-256
  static const double POWER_256 = 1.157920892373162E77;
  static const double POWER_MINUS_256 = 8.636168555094445E-78;
  // 2^128, 2^-128
  static const double POWER_128 = 3.4028236692093846E38;
  static const double POWER_MINUS_128 = 2.9387358770557188E-39;
  // 2^64, 2^-64
  static const double POWER_64 = 18446744073709551616.0;
  static const double POWER_MINUS_64 = 5.421010862427522E-20;
  // 2^52, 2^-52
  static const double POWER_52 = 4503599627370496.0;
  static const double POWER_MINUS_52 = 2.220446049250313E-16;
  // 2^32, 2^-32
  static const double POWER_32 = 4294967296.0;
  static const double POWER_MINUS_32 = 2.3283064365386963E-10;
  // 2^31
  static const double POWER_31 = 2147483648.0;
  // 2^20, 2^-20
  static const double POWER_20 = 1048576.0;
  static const double POWER_MINUS_20 = 9.5367431640625E-7;
  // 2^16, 2^-16
  static const double POWER_16 = 65536.0;
  static const double POWER_MINUS_16 = 0.0000152587890625;
  // 2^8, 2^-8
  static const double POWER_8 = 256.0;
  static const double POWER_MINUS_8 = 0.00390625;
  // 2^4, 2^-4
  static const double POWER_4 = 16.0;
  static const double POWER_MINUS_4 = 0.0625;
  // 2^2, 2^-2
  static const double POWER_2 = 4.0;
  static const double POWER_MINUS_2 = 0.25;
  // 2^1, 2^-1
  static const double POWER_1 = 2.0;
  static const double POWER_MINUS_1 = 0.5;
  // 2^-149 (smallest single non-denorm)
  static const double POWER_MINUS_149 = 1.401298464324817E-45;
  // 2^-1022 (smallest double non-denorm)
  static const double POWER_MINUS_1022 = 2.2250738585072014E-308;
